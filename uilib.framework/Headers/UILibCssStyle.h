...
PROP_RETAIN UIColor*        font_disabled_color;

//PROP_ASSIGN int             bkgrd_color_alpha;//透明度 bkgrd-color-alpha="100" 或="50%" 或="0.5" //0表示全透明，255表示不透明
//
////背景图
